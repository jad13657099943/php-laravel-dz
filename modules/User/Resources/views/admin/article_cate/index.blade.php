    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <div class="test-table-reload-btn" style="margin-bottom: 10px;">
                ...
                <button type="button" class="layui-btn" data-type="create">添加分类</button>
            </div>
...
@push('after-scripts')
    ...
    <script>
        layui.use(['form', 'table', 'util', 'laydate'], function () {
            ...
            table.render({
                elem: '#lay-table',
                url: '{{ route('m.user.api.admin.api.article_cate.index') }}',
            ...
            let active = {
                ...
                create: function () {
                    var url = '{{ route('m.user.admin.article_cate.add') }}';
                    layer.open({
                        type: 2
                        , title: "添加分类"
                        , content: url
