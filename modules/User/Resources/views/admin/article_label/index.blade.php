    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <div class="test-table-reload-btn" style="margin-bottom: 10px;">
                ...
                <button type="button" class="layui-btn" data-type="create">添加标签</button>
            </div>
...
@push('after-scripts')
    ...
    <script>
        layui.use(['form', 'table', 'util', 'laydate'], function () {
            ...
            table.render({
                elem: '#lay-table',
                url: '{{ route('m.user.api.admin.api.article_label.index') }}',
            ...
            table.on("tool(lay-table)", function (e) {
                ...
                if (e.event === 'edit') {
                    if (data.id==1){
                        ...
                        var urls = '{{ route('m.dsy.admin.account.edit') }}?id='+data.id;
                        layer.open({
                            type: 2
                            , title: "编辑账号"
                            , content: urls
                ...
                if (e.event === 'del') {
                    if(data.id==1){
                        ...
                        var url='{{route('m.dsy.api.admin.api.account.del')}}'
            ...
            let active = {
                ...
                create: function () {
                    var url = '{{ route('m.user.admin.article_label.add') }}';
                    layer.open({
                        type: 2
                        , title: "添加标签"
                        , content: url
