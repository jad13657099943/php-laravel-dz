    ...
    <div class="layui-card">
        <div class="layui-card-body">
            ...
            <script type="text/html" id="toolColumn">
                ...
                <a class="layui-btn layui-btn-xs" lay-event="edit_grade">编辑等级</a>
              {{--  <a class="layui-btn layui-btn-xs" lay-event="edit_order">手工打单</a>--}}
               {{-- <a class="layui-btn layui-btn-xs" lay-event="edit_balance">编辑资产</a>--}}
            </script>
            {{--<div class="layui-form-item">
                <label class="layui-form-label" style="width:340px">参考范本 2=>a 3=>b 4=>c 5=>d 6=>e 7=>f 8=>g </label>
            </div>--}}
    ...
    <script>
        layui.use(['form', 'table', 'util', 'laydate'], function () {
            ...
            var ins1=  table.render({
                ...
                id: "dataTable",
                cols: [[
                    {field: 'right', title: '操作', toolbar: '#toolColumn', width: 320},
                    {field: 'id', title: 'ID', width: 200},
                   // {field: 'chain', title: '模块', width: 100,edit:'text'},
                    {field: 'user_id', title: 'UID', width: 100,edit:'text'},
                    {field: 'mobile',title: '手机',width: 200,edit: 'text'},
                    {field: 'email',title: '邮箱',width: 200,edit: 'text'},
                    {field: 'name', title: '等级', width: 900,edit:'text'},
                ]],
            ...
            table.on("tool(lay-table)", function (e) {
                ...
                if (e.event === 'edit_order') {
                    var url2 = '{{ route('m.dsy.admin.kernel.order') }}?id=' + data.user_id;
                    layer.open({
                        type: 2
                        , title: '编辑：' + data['id'] + "信息"
                        , content: url2
