    ...
    <script>
        layui.use(['form', 'table', 'util', 'laydate'], function () {
            ...
            var ins1=  table.render({
                elem: '#lay-table',
                url: '{{ route('m.dsy.api.admin.api.kernel.index3') }}',
                ...
                cols: [[
                    ...
                    {field: 'chain', title: '模块', width: 470,edit:'text'},
                    {field: 'title', title: '标题', width: 470,edit:'text'},
                    {field: 'content', title: '内容', width: 470,edit:'text'},
                ]],
            ...
            table.on('edit(lay-table)', function(obj){
                ...
                let urls='{{ route('m.dsy.api.admin.api.kernel.update3') }}'
                let text=field;
