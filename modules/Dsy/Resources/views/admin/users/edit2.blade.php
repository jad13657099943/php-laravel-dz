    ...
    <div class="layui-card">
        <div class="layui-card-body">
            ...
            <div class="layui-form-item">
                ...
                <label class="layui-form-label">需质押:{{$need}}</label>
                <label class="layui-form-label">已质押:{{$to}}</label>
            </div>

            <div class="layui-form-item">
                <label class="layui-form-label">编辑质押数额</label>
    ...
    <script>
        ...
        layui.use(['form', 'table', 'layedit','laydate','upload','jquery'], function () {
            ...
            $('#add').click(function () {
                ...
                var   url = '{{ route('m.dsy.api.admin.api.user.zhi') }}';
                let   money=$('#num').val();
