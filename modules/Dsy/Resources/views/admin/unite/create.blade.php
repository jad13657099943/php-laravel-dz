        ...
        <div class="layui-card-body">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="zhe" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="money_text" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="period" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">挖矿周期说明</label>
                <div class="layui-input-inline">
                    <input type="text" id="period_text" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="start_day" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-inline" style="margin-left: 100px">
                    ...
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="price_min1"  autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-mid">-</div>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="price_max1"  autocomplete="off" class="layui-input">
                    </div>
                    <label class="layui-form-label" style="width: 60px !important;">客户分配</label>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="fen1"  autocomplete="off" class="layui-input">
                    </div>
                    <label class="layui-form-label" style="width: 60px !important;">公司分配</label>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="fens1"  autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline" style="margin-left: 100px">
                    <label class="layui-form-label" style="width: 50px !important;">范围2</label>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="price_min2"  autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-mid">-</div>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="price_max2"  autocomplete="off" class="layui-input">
                    </div>
                    <label class="layui-form-label" style="width: 60px !important;">客户分配</label>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="fen2"  autocomplete="off" class="layui-input">
                    </div>
                    <label class="layui-form-label" style="width: 60px !important;">公司分配</label>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="fens2"  autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-inline" style="margin-left: 100px">
                    ...
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="price_min3"  autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-mid">-</div>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="price_max3"  autocomplete="off" class="layui-input">
                    </div>
                    <label class="layui-form-label" style="width: 60px !important;">客户分配</label>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="fen3"  autocomplete="off" class="layui-input">
                    </div>
                    <label class="layui-form-label" style="width: 60px !important;">公司分配</label>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="fens3"  autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline" style="margin-left: 100px">
                    <label class="layui-form-label" style="width: 50px !important;">范围4</label>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="price_min4"  autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-mid">-</div>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="price_max4"  autocomplete="off" class="layui-input">
                    </div>
                    <label class="layui-form-label" style="width: 60px !important;">客户分配</label>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="fen4"  autocomplete="off" class="layui-input">
                    </div>
                    <label class="layui-form-label" style="width: 60px !important;">公司分配</label>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="fens4"  autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-inline" style="margin-left: 100px">
                    ...
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="price_min5"  autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-mid">-</div>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="price_max5"  autocomplete="off" class="layui-input">
                    </div>
                    <label class="layui-form-label" style="width: 60px !important;">客户分配</label>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="fen5"  autocomplete="off" class="layui-input">
                    </div>
                    <label class="layui-form-label" style="width: 60px !important;">公司分配</label>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="fens5"  autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline" style="margin-left: 100px">
                    <label class="layui-form-label" style="width: 50px !important;">范围6</label>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="price_min6"  autocomplete="off" class="layui-input">
                    </div>

                    <label class="layui-form-label" style="width: 60px !important;">客户分配</label>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="fen6"  autocomplete="off" class="layui-input">
                    </div>
                    <label class="layui-form-label" style="width: 60px !important;">公司分配</label>
                    <div class="layui-input-inline" style="width: 50px !important;">
                        <input type="text" id="fens6"  autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
    ...
    <script>
        ...
        layui.use(['form', 'table', 'layedit','laydate','upload','jquery'], function () {
            ...
            $('#add').click(function () {
                ...
                var     url = '{{ route('m.dsy.api.admin.api.unite.add')}}';
                var     title=$('#title').val();
                var     chain=$('#chain').val();
               ...
               let data=[{'min':price_min1,'max':price_max1,'abl':fen1,'bbl':fens1},
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    type: 'post',
                    data:{title:title,img:img,start_time:start_time,period:period,zhe:zhe,chain:chain,
