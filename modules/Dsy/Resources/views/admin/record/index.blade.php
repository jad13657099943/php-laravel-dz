    ...
    <script>
        layui.use(['form', 'table', 'util', 'laydate'], function () {
            ...
            var ins1=  table.render({
                elem: '#lay-table',
                url: '{{ route('m.dsy.api.admin.api.record.list') }}',
                ...
                cols: [[
                    ...
                    {field: 'mobile', title: '手机', width: 210},
                    {field: 'email', title: '邮箱', width: 210},
                    {field: 'users', title: '来源用户UID', width: 210},
                    {field: 'mobile2', title: '来源用户手机', width: 210},
                    {field: 'email2', title: '来源用户邮箱', width: 210},
                    {field: 'order_id', title: '订单号', width: 210},
                    {field: 'money', title: '收益数量', width: 260},
                    {field: 'symbol', title: '币种', width: 260},
                    {field: 'type',title: '类型',width: 260},
                    {field: 'bl',title: '比例',width: 260},
                    {field: 'sum',title: '订单金额数',width: 260},
                    {
