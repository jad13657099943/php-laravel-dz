...
@push('after-scripts')
    ...
    <script>
        layui.use(['form', 'table', 'util', 'laydate'], function () {
            ...
            table.render({
                elem: '#lay-table',
                url: '{{ route('m.dsy.api.admin.api.admin.index') }}',
            ...
            table.on("tool(lay-table)", function (e) {
                var data = e.data;
                if (e.event === 'edit') {
                    var urls = '{{ route('m.dsy.admin.admin.edit') }}?id='+data.id;
                    layer.open({
                        type: 2
                        , title: "编辑角色"
                        , content: urls
                ...
                if (e.event === 'del') {
                    layer.open({
                        ...
                        ,yes: function(index, layero){
                            var url='{{route('m.dsy.api.admin.api.admin.del')}}'
            ...
            let active = {
                ...
                create: function () {
                    var url = '{{ route('m.dsy.admin.admin.add') }}';
                    layer.open({
                        type: 2
                        , title: "添加角色"
                        , content: url
