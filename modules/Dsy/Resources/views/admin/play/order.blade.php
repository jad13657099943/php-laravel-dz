    ...
    <div class="layui-card">
        <div class="layui-card-body">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 161px">
                    <select id="type" class="layui-input" lay-filter="aihao">
...
@push('after-scripts')
    <script>
        ...
        $('#add').click(function () {
            var id ={{$id}};
            var url = '{{ route('m.dsy.api.admin.api.play.order') }}';
            var order = $('#order').val();
            var num = $('#num').val();
            let date=$('#date').val();
            let type=$('#type').val();
            $.ajax({
                ...
                dataType: 'json',
                type: 'post',
                data: {user_id: id, commodity_id: order, num: num,buy_at:date,buy_type:type},
