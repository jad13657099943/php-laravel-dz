...
namespace Modules\Dsy\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;

class DsyServiceProvider extends ServiceProvider
{
    /**
     * @var string $moduleName
     */
    protected $moduleName = 'Dsy';

    /**
     * @var string $moduleNameLower
     */
    protected $moduleNameLower = 'dsy';
...
//    }
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            module_path($this->moduleName, 'Config/config.php'), 'dsy::'
        );
    }
