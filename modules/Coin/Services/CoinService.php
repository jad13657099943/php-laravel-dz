...
use Modules\Zkipfs\Services\filecoin\PublicService;
...
class CoinService
{
    ...
    public function syncPrice()
    {
        ...
        if (isset($data['FIL'])) {
          $price= Message::query()->value('last');
            $data['FIL']['USDT'] = $price;
        }
        ...
        if (!empty($address)) {
            switch ($chain) {
                ...
                case 'FIL':
                    ...
                    break;
                case 'TRX':
                    $url= 'https://tronscan.io/#/address/'.$address;
                    break;
                default:
                    $url = '';
                    break;
            ...
            switch ($chain) {
                ...
                case 'FIL':
                    ...
                    break;
                case 'TRX':
                    $url= 'https://tronscan.io/#/transaction/'.$hash;
                    break;
                default:
                    $url = '';
                    break;
