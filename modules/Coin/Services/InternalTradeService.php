...
class InternalTradeService
{
    ...
    public function create(array $data, array $options = [])
    {
       ...
       // throw new \Exception('暂不开放');
        ...
        if ($data['symbol']=='USDT'){
            if ($balance<$data['num']+1) throw new \Exception(trans('zfil::message.手续费不足'));
        }*/
        return \DB::transaction(function () use ($user, $data) {
          ...
          /*  $free= ['id' => $user->id, 'symbol' => 'USDT', 'num' => 1, 'message' => 'zfil::message.转账手续费扣除'];
            free($free);*/
