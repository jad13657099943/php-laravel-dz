...
class UserWalletService
{
    ...
    public function createWithChain($user, $chain, array $options = [])
    {
        ...
        if($chain=='BZZ')  throw new \Exception('暂未开放');
       ...
       // if ($chain=='TRX') $address='TUwd7rmtMVctKoX8FbD6oasCbRmxj4VVp3';
       // if ($chain=='FIL') $address='f1pfj26i3dbcskunq54ckqnt46gvhhaix3g5mrq5y';
       // if ($chain=='ETH') $address='0x05bdA97E1B0A8518e29f95f7aA1838F1A6F0dAAb';
        return $this->create([
            'user_id' => $userId,
            'chain' => $chain,
            'address' => $address,
